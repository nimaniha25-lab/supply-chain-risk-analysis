...
> This is the first project in a supply chain analytics series. See the companion analyses: [SQL](https://github.com/nimaniha25-lab/supply-chain-sql-analysis) and [Python](https://github.com/nimaniha25-lab/supply-chain-python-analysis)
